...
const nodataContainer = document.getElementById('nodata_container');
...
const displayPhone = (phones, isShowAll) => {
  if (phones.length === 0) {
    nodataContainer.innerHTML = `<h4 class="text-3xl font-extrabold text-center">No data available</h4>`;
    ...
    phones.forEach((phone) => {
      productsContainer.innerHTML += `
    <div
      class="flex flex-col items-center justify-center rounded-lg border border-['#CFCFCF'] px-9 py-6 shadow-lg -mt-2">
